 ...
 * [3][2]
 */
public final class BlockSq extends Block {

	public BlockSq(int x, int y, Color color) {
	 ...
	 */
	public BlockSq(int x, int y, Color color, List<Point<Integer>> points) {
		super(x, y, new ArrayList<Box>());
