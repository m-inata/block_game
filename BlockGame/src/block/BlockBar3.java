...
/**
 * 隣接する3つのboxから構成されるブロック
 * [0][1][2]
 */
public class BlockBar3 extends Block {

	public BlockBar3(int x, int y, Color color) {
	 ...
	 */
	public BlockBar3(int x, int y, Color color, List<Point<Integer>> points) {
		super(x, y, new ArrayList<Box>());
	 ...
	 * @param other
	 */
	public BlockBar3(BlockBar3 other) {
		super(other);
